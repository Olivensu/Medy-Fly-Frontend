...
const Footer = () => {
  ...
  <div>
    ...
    <p className="">We know there are a lot of threa <br /> developers our but we pride into a <br />firm in the industry.</p> 
  </div> 
  <div>
...
<footer className="footer px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
  <div className="items-center grid-flow-col">
    ...
    <p><span className='text-orange'>MediFly Ltd.</span> <br/>Providing reliable tech since 1992</p>
  </div> 
